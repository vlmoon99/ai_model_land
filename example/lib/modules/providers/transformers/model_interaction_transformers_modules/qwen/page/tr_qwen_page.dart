...
class TRQwenPage extends StatefulWidget {
  const TRQwenPage({super.key});

  @override
  State<TRQwenPage> createState() => _TRQwenPageState();
}

class _TRQwenPageState extends State<TRQwenPage> {
  ...
  Future<TaskResponseModel> runModel() async {
    return await _aiModelLand.runTaskOnTheModel(
        request: TransformersRequestModel(
            data: messages, optionsForGnerator: {"max_new_tokens": 528}),
        baseModel: baseModel);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(text: "Transformers QWEN Model"),
